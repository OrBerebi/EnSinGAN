...
def generate_dir2save(opt):
    ...
    if (opt.mode == 'train') | (opt.mode == 'SR_train'):
        dir2save = 'TrainedModels/%s/scale_factor=%f,alpha=%f,noise_amp=%f' % (opt.input_name[:-4], opt.scale_factor_init,opt.alpha,opt.noise_amp_init)
        ...
        dir2save = '%s/RandomSamples/%s/gen_start_scale=%d,alpha=%f' % (opt.out,opt.input_name[:-4], opt.gen_start_scale,opt.alpha)
