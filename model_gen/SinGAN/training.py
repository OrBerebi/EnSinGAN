...
def train_single_scale(netD,netG,reals,Gs,Zs,in_s,NoiseAmp,opt,centers=None):
    ...
    for epoch in range(opt.niter):
        ...
        schedulerG.step()
    plot1 = plt.figure(1)
    plt.plot(np.asarray(errD2plot), label ="Scale: "+str(len(Gs)))
    plt.xlabel('epochs')
    plt.ylabel('err D')
    plt.title('Error D')
    plt.grid(True)
    ...
    plot3 = plt.figure(3)
    plt.plot(np.asarray(D_real2plot), label ="Scale: "+str(len(Gs)))
    plt.xlabel('epochs')
    plt.ylabel('realD')
    plt.title('D real')
    plt.grid(True)
    plt.legend()
    plt.savefig('%s/D_real.png' % (opt.outf))

    plot4 = plt.figure(4)
    plt.plot(np.asarray(D_fake2plot), label ="Scale: "+str(len(Gs)))
    plt.xlabel('epochs')
    plt.ylabel('fakeD')
    plt.title('D fake')
    plt.grid(True)
    plt.legend()
    plt.savefig('%s/D_fake.png' % (opt.outf))
    
    plot5 = plt.figure(5)
    plt.plot(np.asarray(z_opt2plot), label ="Scale: "+str(len(Gs)))
    plt.xlabel('epochs')
    plt.ylabel('z_opt')
    plt.title('Z opt')
    plt.grid(True)
    plt.legend()
    plt.savefig('%s/z_opt.png' % (opt.outf))
   ...
   # if len(Gs)==1 or len(Gs)==4:
    ...
    plt.grid(True)
    plt.legend()
    plt.savefig('%s/Generator_train_curve_loss.png' % (opt.outf))
